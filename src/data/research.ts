...
export type Area = {
  ...
  summary: string;
  /** Optional outbound link, e.g. the group's project page. */
...
export const current: Area[] = [
  {
    ...
    link: {
      label: 'Rydberg project, Quantum Photonics team at JEIP',
      href: 'https://jeipcdf.cnrs.fr/quantum-photonics/rydberg-project/',
    },
    body: [
